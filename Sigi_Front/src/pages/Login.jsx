...
// Este componente representa el formulario de inicio de sesión para los usuarios de la plataforma.
import { Link } from 'react-router-dom';

export default function Login() {
  // Estado para mostrar un spinner o deshabilitar el botón mientras se envía el formulario
  const [isLoading, setIsLoading] = useState(false);
  // Estado para mostrar o no la contraseña. Nos ayuda a que el usuario pueda ver lo que escribe.
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      {/*
        ...
        Aquí mostramos el nombre de la municipalidad y el propósito de la plataforma.
      */}
      ...
      {/*
        ...
        Aquí está el formulario principal donde el usuario ingresa sus credenciales.
      */}
